<template>
    <div class="friend-list">
        <h2 class="text-2xl font-bold mb-4 text-center ">Friend List</h2>
        <ul>
            <li class="">
            ...
            <li v-for="friend in pendingFriends" :key="friend.id" class="mb-2 bg-blue-200">
                {{ friend.username }}
                <button @click="acceptFriend(friend)" class="rounded-sm bg-green-300 px-3 py-1">
                    Accept
                </button>
            </li>
